    ...
    class="badge badge badge-danger badge-pill float-right mr-2">{{ App\Models\Category::count() }}</span>
            ...
            <li class="active" class="nav-item"><a href=""><i class="la la-male"></i>
                ...
                <ul class="menu-content">
                    ...
                    <li class="active"><a class="menu-item" href="{{ route('admin.tags.create') }}" data-i18n="nav.dash.crypto">
                            إضافة علامة جديدة </a>
                    </li>
                </ul>
            </li>
            <li class="active" class="nav-item"><a href=""><i class="la la-male"></i>
                ...
                <ul class="menu-content">
                    ...
                    <li class="active"><a class="menu-item" href="{{ route('admin.products.general.create') }}" data-i18n="nav.dash.crypto">
                            إضافة منتج جديد </a>
                    </li>
                </ul>
            </li>
